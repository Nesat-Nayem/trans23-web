        ...
        <div className='lg:flex grid justify-around py-20 bg-gray-100'>
            <div className='lg:-mr-96 grid items-center lg:w-96 px-10 lg:px-0'>
                ...
                <div data-aos="fade-right" data-aos-duration="2500">
                    ...
                    <h1 className='text-4xl font-bold my-4'>A Great <br /> Moving Service</h1>
                    ...
                    <div className='flex justify-center mt-10 mb-8 lg:mb-0'>
                        <Link to="/" className='uppercase bg-gradient-to-r from-rose-600 to-pink-600 px-6 py-3 rounded-full text-white font-semibold tracking-widest'>about eventy</Link>
                    </div>
                </div>
            </div>
            ...
            <div className='grid justify-center lg:w-[800px]'>
                ...
                <div className='lg:flex'>
                    ...
                    >
                        ...
                        <div className='-mt-16 px-3'>
                            <p className='text-center text-lg font-bold'>Perfact Moving</p>
                            <p className='text-center text-sm text-gray-500'>Perfact Moving</p>
                        </div>
                    </div>
                    ...
                    >
                        ...
                        <div className='-mt-16 px-3'>
                            <p className='text-center text-lg font-bold'>Safe Delivery</p>
                ...
                <div className='lg:flex'>
                    ...
                    >
                        ...
                        <div className='-mt-16 px-3'>
                            <p className='text-center text-lg font-bold'>Compare prices</p>
                            <p className='text-center text-sm text-gray-500'>We have Compare prices</p>
                        </div>
                    </div>
                </div>
